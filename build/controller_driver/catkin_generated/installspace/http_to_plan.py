...
# @app.route('/calculate_target_orientation_from_theta', methods=['POST'])
# def calculate_target_orientation_from_theta():
#     data = request.get_json()
#     if not data:
#         return jsonify({
#             "success": False,
...
#     target_orientation = caculate_target_orientation(theta, orientation)
#     if target_orientation is None:
#         return jsonify({
#             "success": False,
#             "error": "Failed to calculate target orientation"
#         }), 500
