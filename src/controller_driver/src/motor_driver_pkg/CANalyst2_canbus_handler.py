...
class CanbusHandler:
    ...
    def __init__(self,
        ...
        if system == "Windows":
            ...
            self.can_dll = ctypes.cdll.LoadLibrary("libcontrolcan.so")
        else:
    ...
    def scan_devices() -> List[Dict]:
        ...
        if system == "Windows":
            ...
            print("Scanning for USB-CAN devices on Linux...")
            dll = ctypes.cdll.LoadLibrary("libcontrolcan.so")
            print("Loaded libcontrolcan.so for device scanning.")
        else:
            raise OSError(f"Unsupported operating system: {system}")
        ...
        try:
            ...
            print(f"Found {num_devices} USB-CAN devices.")
