...
"""autogenerated by genpy from controller_driver/LegMoveActionResult.msg. Do not edit."""
import codecs
import sys
...
class LegMoveActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "controller_driver/LegMoveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','controller_driver/LegMoveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LegMoveActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = controller_driver.msg.LegMoveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = controller_driver.msg.LegMoveResult()
